...
defmodule Googly.DocumentAI.Projects.Locations.Operations do
  @moduledoc """
  Endpoints for the `Projects.Locations.Operations` resource.
  """
  ...
  *   `{:ok, %Googly.DocumentAI.Model.GoogleLongrunningListOperationsResponse{}}` on success
  *   `{:error, %Googly.DocumentAI.Error{}}` on failure
  """
  @spec list(String.t(), keyword()) ::
          {:ok, Googly.DocumentAI.Model.GoogleLongrunningListOperationsResponse.t()}
          | {:error, term()}
  def list(name, opts \\ []) do
    Request.run(
      ...
      decode: Googly.DocumentAI.Model.GoogleLongrunningListOperationsResponse,
      opts: opts
    )
  end
end
