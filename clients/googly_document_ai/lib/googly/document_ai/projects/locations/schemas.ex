...
defmodule Googly.DocumentAI.Projects.Locations.Schemas do
  @moduledoc """
  ...
  *   `{:error, %Googly.DocumentAI.Error{}}` on failure
  ...
  @spec create(String.t(), keyword()) ::
          {:ok, Googly.DocumentAI.Model.GoogleCloudDocumentaiV1NextSchema.t()} | {:error, term()}
  def create(parent, opts \\ []) do
    Request.run(
      method: :post,
      url: "/v1/{+parent}/schemas",
      ...
      decode: Googly.DocumentAI.Model.GoogleCloudDocumentaiV1NextSchema,
      opts: opts
    )
  end
  ...
  *   `opts` (*type:* `keyword()`) - Query and call options (`:token`, plus any of the below)
      ...
      *   `upload_type` (*type:* `String.t()`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `xgafv` (*type:* `String.t()`) - V1 error format.
      *   `page_size` (*type:* `integer()`) - Optional. The maximum number of schema groups to return. If unspecified, at most `10` Schema will be returned. The maximum value is `20`. Values above `20` will be coerced to `20`.
  ...
  *   `{:error, %Googly.DocumentAI.Error{}}` on failure
  ...
  @spec list(String.t(), keyword()) ::
          {:ok, Googly.DocumentAI.Model.GoogleCloudDocumentaiV1ListSchemasResponse.t()}
          | {:error, term()}
  def list(parent, opts \\ []) do
    Request.run(
      ...
      decode: Googly.DocumentAI.Model.GoogleCloudDocumentaiV1ListSchemasResponse,
      opts: opts
    )
  end
