...
defmodule Googly.DocumentAI.Model.GoogleCloudDocumentaiV1beta3BatchProcessMetadata do
  @moduledoc """
  ...
  *   `individual_process_statuses` (*type:* `list(Googly.DocumentAI.Model.GoogleCloudDocumentaiV1beta3BatchProcessMetadataIndividualProcessStatus.t())`) - The list of response details of each document.
  ...
  *   `update_time` (*type:* `DateTime.t()`) - The last update time of the operation.
  ...
  @type t :: %__MODULE__{
          ...
          individual_process_statuses:
            list(
              Googly.DocumentAI.Model.GoogleCloudDocumentaiV1beta3BatchProcessMetadataIndividualProcessStatus.t()
            )
            | nil,
          state: String.t() | nil,
  ...
  def decode(m) do
    %__MODULE__{
      ...
      individual_process_statuses:
        Googly.DocumentAI.Model.GoogleCloudDocumentaiV1beta3BatchProcessMetadataIndividualProcessStatus.decode(
