...
defmodule Googly.DocumentAI.Model.GoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypeProperty do
  @moduledoc """
  ...
  *   `value_type` (*type:* `String.t()`) - A reference to the value type of the property. This type is subject to the same conventions as the `Entity.base_types` field.
  ...
  @type t :: %__MODULE__{
          ...
          property_metadata:
            Googly.DocumentAI.Model.GoogleCloudDocumentaiV1beta3PropertyMetadata.t() | nil,
  ...
  def decode(m) do
    %__MODULE__{
      ...
      property_metadata:
        Googly.DocumentAI.Model.GoogleCloudDocumentaiV1beta3PropertyMetadata.decode(
          m["propertyMetadata"]
        ),
