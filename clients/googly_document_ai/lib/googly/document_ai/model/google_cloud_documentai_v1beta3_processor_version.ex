...
defmodule Googly.DocumentAI.Model.GoogleCloudDocumentaiV1beta3ProcessorVersion do
  @moduledoc """
  ...
  *   `state` (*type:* `String.t()`) - Output only. The state of the processor version.
  ...
  @type t :: %__MODULE__{
          ...
          latest_evaluation:
            Googly.DocumentAI.Model.GoogleCloudDocumentaiV1beta3EvaluationReference.t() | nil,
  ...
  def decode(m) do
    %__MODULE__{
      ...
      deprecation_info:
        Googly.DocumentAI.Model.GoogleCloudDocumentaiV1beta3ProcessorVersionDeprecationInfo.decode(
          m["deprecationInfo"]
        ),
      display_name: m["displayName"],
      document_schema:
        Googly.DocumentAI.Model.GoogleCloudDocumentaiV1beta3DocumentSchema.decode(
          m["documentSchema"]
        ),
      gen_ai_model_info:
        Googly.DocumentAI.Model.GoogleCloudDocumentaiV1beta3ProcessorVersionGenAiModelInfo.decode(
          m["genAiModelInfo"]
        ),
      ...
      latest_evaluation:
        Googly.DocumentAI.Model.GoogleCloudDocumentaiV1beta3EvaluationReference.decode(
          m["latestEvaluation"]
        ),
