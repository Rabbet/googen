...
defmodule Googly.DocumentAI.Model.GoogleCloudDocumentaiV1beta3Processor do
  @moduledoc """
  ...
  *   `processor_version_aliases` (*type:* `list(Googly.DocumentAI.Model.GoogleCloudDocumentaiV1beta3ProcessorVersionAlias.t())`) - Output only. The processor version aliases.
  ...
  *   `type` (*type:* `String.t()`) - The processor type, such as: `OCR_PROCESSOR`, `INVOICE_PROCESSOR`. To get a list of processor types, see FetchProcessorTypes.
  ...
  @type t :: %__MODULE__{
          ...
          processor_version_aliases:
            list(Googly.DocumentAI.Model.GoogleCloudDocumentaiV1beta3ProcessorVersionAlias.t())
            | nil,
  ...
  def decode(m) do
    %__MODULE__{
      ...
      processor_version_aliases:
        Googly.DocumentAI.Model.GoogleCloudDocumentaiV1beta3ProcessorVersionAlias.decode(
