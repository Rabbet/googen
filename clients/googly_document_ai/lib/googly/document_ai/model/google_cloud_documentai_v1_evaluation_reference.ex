...
defmodule Googly.DocumentAI.Model.GoogleCloudDocumentaiV1EvaluationReference do
  @moduledoc """
  ...
  *   `operation` (*type:* `String.t()`) - The resource name of the Long Running Operation for the evaluation.
  ...
  @type t :: %__MODULE__{
          aggregate_metrics:
            Googly.DocumentAI.Model.GoogleCloudDocumentaiV1EvaluationMetrics.t() | nil,
  ...
  def decode(m) do
    %__MODULE__{
      aggregate_metrics:
        Googly.DocumentAI.Model.GoogleCloudDocumentaiV1EvaluationMetrics.decode(
          m["aggregateMetrics"]
        ),
      aggregate_metrics_exact:
        Googly.DocumentAI.Model.GoogleCloudDocumentaiV1EvaluationMetrics.decode(
