...
defmodule Googly.DocumentAI.Model.GoogleCloudDocumentaiV1Processor do
  @moduledoc """
  ...
  *   `type` (*type:* `String.t()`) - The processor type, such as: `OCR_PROCESSOR`, `INVOICE_PROCESSOR`. To get a list of processor types, see FetchProcessorTypes.
  ...
  @type t :: %__MODULE__{
          ...
          processor_version_aliases:
            list(Googly.DocumentAI.Model.GoogleCloudDocumentaiV1ProcessorVersionAlias.t()) | nil,
  ...
  def decode(m) do
    %__MODULE__{
      ...
      processor_version_aliases:
        Googly.DocumentAI.Model.GoogleCloudDocumentaiV1ProcessorVersionAlias.decode(
