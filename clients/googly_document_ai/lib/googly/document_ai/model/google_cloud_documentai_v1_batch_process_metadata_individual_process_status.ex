...
defmodule Googly.DocumentAI.Model.GoogleCloudDocumentaiV1BatchProcessMetadataIndividualProcessStatus do
  @moduledoc """
  ...
  *   `status` (*type:* `Googly.DocumentAI.Model.GoogleRpcStatus.t()`) - The status processing the document.
  ...
  defstruct [:human_review_status, :input_gcs_source, :output_gcs_destination, :status]
