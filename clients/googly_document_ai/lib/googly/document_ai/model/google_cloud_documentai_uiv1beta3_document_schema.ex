...
defmodule Googly.DocumentAI.Model.GoogleCloudDocumentaiUiv1beta3DocumentSchema do
  @moduledoc """
  ...
  *   `metadata` (*type:* `Googly.DocumentAI.Model.GoogleCloudDocumentaiUiv1beta3DocumentSchemaMetadata.t()`) - Metadata of the schema.
  ...
  @type t :: %__MODULE__{
          ...
          entity_types:
            ...
            | nil,
          metadata:
            Googly.DocumentAI.Model.GoogleCloudDocumentaiUiv1beta3DocumentSchemaMetadata.t() | nil
        }
  ...
  def decode(m) do
    %__MODULE__{
      ...
      entity_types:
        Googly.DocumentAI.Model.GoogleCloudDocumentaiUiv1beta3DocumentSchemaEntityType.decode(
          m["entityTypes"]
        ),
      metadata:
        Googly.DocumentAI.Model.GoogleCloudDocumentaiUiv1beta3DocumentSchemaMetadata.decode(
          m["metadata"]
        )
    }
  end
