...
defmodule Googly.CloudStorage.Model.BucketEncryptionGoogleManagedEncryptionEnforcementConfig do
  @moduledoc """
  ...
  *   `restriction_mode` (*type:* `String.t()`) - Restriction mode for Google-Managed Encryption Keys. Defaults to NotRestricted.
  """
