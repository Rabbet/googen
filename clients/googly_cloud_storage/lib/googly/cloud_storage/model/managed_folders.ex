...
defmodule Googly.CloudStorage.Model.ManagedFolders do
  @moduledoc """
  ...
  *   `next_page_token` (*type:* `String.t()`) - The continuation token, used to page through large result sets. Provide this value in a subsequent request to return the next page of results.
  ...
  @type t :: %__MODULE__{
          items: list(Googly.CloudStorage.Model.ManagedFolder.t()) | nil,
          kind: String.t() | nil,
  ...
  def decode(m) do
    %__MODULE__{
      items: Googly.CloudStorage.Model.ManagedFolder.decode(m["items"]),
      kind: m["kind"],
