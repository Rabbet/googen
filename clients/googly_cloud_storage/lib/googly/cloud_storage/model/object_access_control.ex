...
defmodule Googly.CloudStorage.Model.ObjectAccessControl do
  @moduledoc """
  ...
  *   `self_link` (*type:* `String.t()`) - The link to this access-control entry.
  ...
  @type t :: %__MODULE__{
          ...
          kind: String.t() | nil,
          object: String.t() | nil,
          project_team: Googly.CloudStorage.Model.ObjectAccessControlProjectTeam.t() | nil,
          role: String.t() | nil,
  ...
  def decode(m) do
    %__MODULE__{
      ...
      object: m["object"],
      project_team:
        Googly.CloudStorage.Model.ObjectAccessControlProjectTeam.decode(m["projectTeam"]),
      role: m["role"],
