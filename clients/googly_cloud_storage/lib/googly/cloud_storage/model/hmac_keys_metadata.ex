...
defmodule Googly.CloudStorage.Model.HmacKeysMetadata do
  @moduledoc """
  A list of hmacKeys.
  ...
  *   `next_page_token` (*type:* `String.t()`) - The continuation token, used to page through large result sets. Provide this value in a subsequent request to return the next page of results.
  ...
  @type t :: %__MODULE__{
          items: list(Googly.CloudStorage.Model.HmacKeyMetadata.t()) | nil,
          kind: String.t() | nil,
  ...
  def decode(m) do
    %__MODULE__{
      items: Googly.CloudStorage.Model.HmacKeyMetadata.decode(m["items"]),
      kind: m["kind"],
