...
defmodule Googly.CloudStorage.ObjectAccessControls do
  @moduledoc """
  ...
  *   `{:error, %Googly.CloudStorage.Error{}}` on failure
  ...
  def delete(bucket, object, entity, opts \\ []) do
    Request.run(
      method: :delete,
  ...
  *   `{:error, %Googly.CloudStorage.Error{}}` on failure
  ...
  def get(bucket, object, entity, opts \\ []) do
    Request.run(
      method: :get,
      url: "/storage/v1/b/{bucket}/o/{object}/acl/{entity}",
      path_params: %{
  ...
  *   `{:error, %Googly.CloudStorage.Error{}}` on failure
  ...
  @spec insert(String.t(), String.t(), keyword()) ::
          {:ok, Googly.CloudStorage.Model.ObjectAccessControl.t()} | {:error, term()}
  def insert(bucket, object, opts \\ []) do
    Request.run(
      method: :post,
  ...
  *   `{:error, %Googly.CloudStorage.Error{}}` on failure
  ...
  def list(bucket, object, opts \\ []) do
    Request.run(
      method: :get,
      url: "/storage/v1/b/{bucket}/o/{object}/acl",
      path_params: %{
  ...
  *   `{:error, %Googly.CloudStorage.Error{}}` on failure
  ...
  @spec patch(String.t(), String.t(), String.t(), keyword()) ::
          {:ok, Googly.CloudStorage.Model.ObjectAccessControl.t()} | {:error, term()}
  def patch(bucket, object, entity, opts \\ []) do
    Request.run(
      method: :patch,
      url: "/storage/v1/b/{bucket}/o/{object}/acl/{entity}",
      path_params: %{
  ...
  *   `{:error, %Googly.CloudStorage.Error{}}` on failure
  ...
  @spec update(String.t(), String.t(), String.t(), keyword()) ::
          {:ok, Googly.CloudStorage.Model.ObjectAccessControl.t()} | {:error, term()}
  def update(bucket, object, entity, opts \\ []) do
    Request.run(
      method: :put,
      url: "/storage/v1/b/{bucket}/o/{object}/acl/{entity}",
      path_params: %{
