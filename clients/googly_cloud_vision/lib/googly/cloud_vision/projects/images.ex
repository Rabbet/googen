...
defmodule Googly.CloudVision.Projects.Images do
  @moduledoc """
  Endpoints for the `Projects.Images` resource.
  """
  ...
  *   `{:error, %Googly.CloudVision.Error{}}` on failure
  ...
  def async_batch_annotate(parent, opts \\ []) do
    Request.run(
      method: :post,
      url: "/v1/{+parent}/images:asyncBatchAnnotate",
      path_params: %{"parent" => URI.encode(parent, &URI.char_unreserved?/1)},
      query: [],
      params: %{
        access_token: {:query, "access_token"},
