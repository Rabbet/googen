...
defmodule Googly.CloudVision.Model.AsyncBatchAnnotateFilesResponse do
  @moduledoc """
  ...
  *   `responses` (*type:* `list(Googly.CloudVision.Model.AsyncAnnotateFileResponse.t())`) - The list of file annotation responses, one for each request in AsyncBatchAnnotateFilesRequest.
  ...
  @type t :: %__MODULE__{
          responses: list(Googly.CloudVision.Model.AsyncAnnotateFileResponse.t()) | nil
        }
  ...
  def decode(m) do
    %__MODULE__{
      responses: Googly.CloudVision.Model.AsyncAnnotateFileResponse.decode(m["responses"])
    }
  end
end
