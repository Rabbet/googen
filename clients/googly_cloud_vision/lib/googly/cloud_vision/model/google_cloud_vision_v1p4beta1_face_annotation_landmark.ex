...
defmodule Googly.CloudVision.Model.GoogleCloudVisionV1p4beta1FaceAnnotationLandmark do
  @moduledoc """
  ...
  *   `position` (*type:* `Googly.CloudVision.Model.GoogleCloudVisionV1p4beta1Position.t()`) - Face landmark position.
  *   `type` (*type:* `String.t()`) - Face landmark type.
  ...
  @type t :: %__MODULE__{
          position: Googly.CloudVision.Model.GoogleCloudVisionV1p4beta1Position.t() | nil,
          type: String.t() | nil
        }
  ...
  def decode(m) do
    %__MODULE__{
      position: Googly.CloudVision.Model.GoogleCloudVisionV1p4beta1Position.decode(m["position"]),
      type: m["type"]
    }
  end
end
