...
defmodule Googly.CloudVision.Model.GoogleCloudVisionV1p4beta1ReferenceImage do
  @moduledoc """
  A `ReferenceImage` represents a product image and its associated metadata, such as bounding boxes.

  ## Attributes

  *   `bounding_polys` (*type:* `list(Googly.CloudVision.Model.GoogleCloudVisionV1p4beta1BoundingPoly.t())`) - Optional. Bounding polygons around the areas of interest in the reference image. If this field is empty, the system will try to detect regions of interest. At most 10 bounding polygons will be used. The provided shape is converted into a non-rotated rectangle. Once converted, the small edge of the rectangle must be greater than or equal to 300 pixels. The aspect ratio must be 1:4 or less (i.e. 1:3 is ok; 1:5 is not).
  ...
  *   `uri` (*type:* `String.t()`) - Required. The Google Cloud Storage URI of the reference image. The URI must start with `gs://`.
  ...
  @type t :: %__MODULE__{
          bounding_polys:
            list(Googly.CloudVision.Model.GoogleCloudVisionV1p4beta1BoundingPoly.t()) | nil,
          name: String.t() | nil,
          uri: String.t() | nil
        }
  ...
  def decode(m) do
    %__MODULE__{
      bounding_polys:
        Googly.CloudVision.Model.GoogleCloudVisionV1p4beta1BoundingPoly.decode(m["boundingPolys"]),
      name: m["name"],
      uri: m["uri"]
    }
  end
