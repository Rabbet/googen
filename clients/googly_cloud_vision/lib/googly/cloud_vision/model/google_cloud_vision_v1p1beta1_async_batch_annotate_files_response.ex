...
defmodule Googly.CloudVision.Model.GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesResponse do
  @moduledoc """
  ...
  *   `responses` (*type:* `list(Googly.CloudVision.Model.GoogleCloudVisionV1p1beta1AsyncAnnotateFileResponse.t())`) - The list of file annotation responses, one for each request in AsyncBatchAnnotateFilesRequest.
  ...
  @type t :: %__MODULE__{
          responses:
            list(Googly.CloudVision.Model.GoogleCloudVisionV1p1beta1AsyncAnnotateFileResponse.t())
            | nil
        }
  ...
  def decode(m) do
    %__MODULE__{
      responses:
        Googly.CloudVision.Model.GoogleCloudVisionV1p1beta1AsyncAnnotateFileResponse.decode(
          m["responses"]
        )
    }
  end
