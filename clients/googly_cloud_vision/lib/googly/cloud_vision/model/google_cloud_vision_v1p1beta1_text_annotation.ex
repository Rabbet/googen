...
defmodule Googly.CloudVision.Model.GoogleCloudVisionV1p1beta1TextAnnotation do
  @moduledoc """
  ...
  *   `text` (*type:* `String.t()`) - UTF-8 text detected on the pages.
  ...
  @type t :: %__MODULE__{
          pages: list(Googly.CloudVision.Model.GoogleCloudVisionV1p1beta1Page.t()) | nil,
          text: String.t() | nil
        }
  ...
  def decode(m) do
    %__MODULE__{
      pages: Googly.CloudVision.Model.GoogleCloudVisionV1p1beta1Page.decode(m["pages"]),
      text: m["text"]
    }
  end
end
