...
defmodule Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1ProductSearchResultsResult do
  @moduledoc """
  ...
  *   `score` (*type:* `number()`) - A confidence level on the match, ranging from 0 (no confidence) to 1 (full confidence).
  ...
  @type t :: %__MODULE__{
          image: String.t() | nil,
          product: Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1Product.t() | nil,
          score: number() | nil
        }
  ...
  def decode(m) do
    %__MODULE__{
      image: m["image"],
      product: Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1Product.decode(m["product"]),
      score: m["score"]
    }
  end
end
