...
defmodule Googly.CloudVision.Model.GoogleCloudVisionV1p3beta1CropHint do
  @moduledoc """
  Single crop hint that is used to generate a new crop when serving an image.

  ## Attributes

  *   `bounding_poly` (*type:* `Googly.CloudVision.Model.GoogleCloudVisionV1p3beta1BoundingPoly.t()`) - The bounding polygon for the crop region. The coordinates of the bounding box are in the original image's scale.
