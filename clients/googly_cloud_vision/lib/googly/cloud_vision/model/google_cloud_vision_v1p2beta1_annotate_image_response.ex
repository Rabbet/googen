...
defmodule Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1AnnotateImageResponse do
  @moduledoc """
  ...
  *   `web_detection` (*type:* `Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1WebDetection.t()`) - If present, web detection has completed successfully.
  ...
  @type t :: %__MODULE__{
          context:
            Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1ImageAnnotationContext.t() | nil,
          crop_hints_annotation:
            Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1CropHintsAnnotation.t() | nil,
          error: Googly.CloudVision.Model.Status.t() | nil,
          face_annotations:
            list(Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1FaceAnnotation.t()) | nil,
          full_text_annotation:
            Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1TextAnnotation.t() | nil,
          image_properties_annotation:
            Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1ImageProperties.t() | nil,
          label_annotations:
            list(Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1EntityAnnotation.t()) | nil,
          landmark_annotations:
            list(Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1EntityAnnotation.t()) | nil,
          localized_object_annotations:
            list(Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1LocalizedObjectAnnotation.t())
            | nil,
          logo_annotations:
            list(Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1EntityAnnotation.t()) | nil,
          product_search_results:
            Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1ProductSearchResults.t() | nil,
          safe_search_annotation:
            Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1SafeSearchAnnotation.t() | nil,
          text_annotations:
            list(Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1EntityAnnotation.t()) | nil,
          web_detection: Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1WebDetection.t() | nil
        }
  ...
  def decode(m) do
    %__MODULE__{
      context:
        Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1ImageAnnotationContext.decode(
          m["context"]
        ),
      crop_hints_annotation:
        Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1CropHintsAnnotation.decode(
          m["cropHintsAnnotation"]
        ),
      error: Googly.CloudVision.Model.Status.decode(m["error"]),
      face_annotations:
        Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1FaceAnnotation.decode(
          m["faceAnnotations"]
        ),
      full_text_annotation:
        Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1TextAnnotation.decode(
          m["fullTextAnnotation"]
        ),
      image_properties_annotation:
        Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1ImageProperties.decode(
          m["imagePropertiesAnnotation"]
        ),
      label_annotations:
        Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1EntityAnnotation.decode(
          m["labelAnnotations"]
        ),
      landmark_annotations:
        Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1EntityAnnotation.decode(
      ...
      localized_object_annotations:
        Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1LocalizedObjectAnnotation.decode(
      ...
      product_search_results:
        Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1ProductSearchResults.decode(
          m["productSearchResults"]
        ),
      safe_search_annotation:
        Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1SafeSearchAnnotation.decode(
      ...
      web_detection:
        Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1WebDetection.decode(m["webDetection"])
    }
  end
end
