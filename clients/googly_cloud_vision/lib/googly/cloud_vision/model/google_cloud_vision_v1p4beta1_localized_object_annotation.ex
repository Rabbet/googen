...
defmodule Googly.CloudVision.Model.GoogleCloudVisionV1p4beta1LocalizedObjectAnnotation do
  @moduledoc """
  Set of detected objects with bounding boxes.

  ## Attributes

  *   `bounding_poly` (*type:* `Googly.CloudVision.Model.GoogleCloudVisionV1p4beta1BoundingPoly.t()`) - Image region to which this object belongs. This must be populated.
