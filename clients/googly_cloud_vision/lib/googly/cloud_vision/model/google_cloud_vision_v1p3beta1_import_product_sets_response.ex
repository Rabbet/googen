...
defmodule Googly.CloudVision.Model.GoogleCloudVisionV1p3beta1ImportProductSetsResponse do
  @moduledoc """
  ...
  *   `statuses` (*type:* `list(Googly.CloudVision.Model.Status.t())`) - The rpc status for each ImportProductSet request, including both successes and errors. The number of statuses here matches the number of lines in the csv file, and statuses[i] stores the success or failure status of processing the i-th line of the csv, starting from line 0.
  ...
  @type t :: %__MODULE__{
          reference_images:
            list(Googly.CloudVision.Model.GoogleCloudVisionV1p3beta1ReferenceImage.t()) | nil,
  ...
  def decode(m) do
    %__MODULE__{
      reference_images:
        Googly.CloudVision.Model.GoogleCloudVisionV1p3beta1ReferenceImage.decode(
          m["referenceImages"]
        ),
