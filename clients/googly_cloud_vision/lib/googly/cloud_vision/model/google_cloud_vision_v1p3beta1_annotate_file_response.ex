...
defmodule Googly.CloudVision.Model.GoogleCloudVisionV1p3beta1AnnotateFileResponse do
  @moduledoc """
  ...
  *   `responses` (*type:* `list(Googly.CloudVision.Model.GoogleCloudVisionV1p3beta1AnnotateImageResponse.t())`) - Individual responses to images found within the file. This field will be empty if the `error` field is set.
  *   `total_pages` (*type:* `integer()`) - This field gives the total number of pages in the file.
  ...
  @type t :: %__MODULE__{
          ...
          input_config: Googly.CloudVision.Model.GoogleCloudVisionV1p3beta1InputConfig.t() | nil,
          responses:
            list(Googly.CloudVision.Model.GoogleCloudVisionV1p3beta1AnnotateImageResponse.t())
            | nil,
  ...
  def decode(m) do
    %__MODULE__{
      ...
      input_config:
        Googly.CloudVision.Model.GoogleCloudVisionV1p3beta1InputConfig.decode(m["inputConfig"]),
      responses:
        Googly.CloudVision.Model.GoogleCloudVisionV1p3beta1AnnotateImageResponse.decode(
          m["responses"]
        ),
