...
defmodule Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1LocalizedObjectAnnotation do
  @moduledoc """
  Set of detected objects with bounding boxes.

  ## Attributes

  *   `bounding_poly` (*type:* `Googly.CloudVision.Model.GoogleCloudVisionV1p2beta1BoundingPoly.t()`) - Image region to which this object belongs. This must be populated.
  ...
  *   `score` (*type:* `number()`) - Score of the result. Range [0, 1].
  ...
  defstruct [:bounding_poly, :language_code, :mid, :name, :score]
  ...
  @wire %{bounding_poly: "boundingPoly", language_code: "languageCode"}
  @doc false
