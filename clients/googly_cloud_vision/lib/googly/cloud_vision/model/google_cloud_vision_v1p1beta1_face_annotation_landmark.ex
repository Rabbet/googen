...
defmodule Googly.CloudVision.Model.GoogleCloudVisionV1p1beta1FaceAnnotationLandmark do
  @moduledoc """
  ...
  *   `type` (*type:* `String.t()`) - Face landmark type.
  ...
  @type t :: %__MODULE__{
          position: Googly.CloudVision.Model.GoogleCloudVisionV1p1beta1Position.t() | nil,
          type: String.t() | nil
        }
  ...
  def decode(m) do
    %__MODULE__{
      position: Googly.CloudVision.Model.GoogleCloudVisionV1p1beta1Position.decode(m["position"]),
      type: m["type"]
    }
  end
end
