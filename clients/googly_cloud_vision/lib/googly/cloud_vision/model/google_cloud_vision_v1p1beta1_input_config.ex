...
defmodule Googly.CloudVision.Model.GoogleCloudVisionV1p1beta1InputConfig do
  @moduledoc """
  ...
  *   `mime_type` (*type:* `String.t()`) - The type of the file. Currently only "application/pdf", "image/tiff" and "image/gif" are supported. Wildcards are not supported.
  ...
  @type t :: %__MODULE__{
          ...
          gcs_source: Googly.CloudVision.Model.GoogleCloudVisionV1p1beta1GcsSource.t() | nil,
  ...
  def decode(m) do
    %__MODULE__{
      content: m["content"],
      gcs_source:
        Googly.CloudVision.Model.GoogleCloudVisionV1p1beta1GcsSource.decode(m["gcsSource"]),
